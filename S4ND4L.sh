...
echo -b "AUTHOR    : ILANGQWER  $green " |lolcat
...
echo -b "NOTES     : SUBSCRIBE TO MY CHANNEL DUNIA SCRIPT " | lolcat
echo -b "_____________________________________________________________" | lolcat
...
sleep 1
echo -b $green"[#]> S4ND4L J3PIT On Your System" |lolcat

echo -b $green"[#]> See you Again SCRIPTKIDDIES😎 :)..." |lolcat
figlet S4ND4L J3PIT | lolcat
sleep 1
exit
}
...
00) echo "AUTHOR: S4ND4L J3PIT" | lolcat
echo "S4ND4L J3PIT ON YOUR SYSTEM" | lolcat
